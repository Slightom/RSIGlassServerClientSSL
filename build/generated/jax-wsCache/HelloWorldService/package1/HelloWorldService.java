 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://package1/", wsdlLocation = "http://asuslightom:21346/WebServicesGlass/HelloWorldService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://package1/", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://asuslightom:21346/WebServicesGlass/HelloWorldService?wsdl");
    ...
    public IHelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://package1/", "HelloWorldPort"), IHelloWorld.class);
    }
    ...
    public IHelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://package1/", "HelloWorldPort"), IHelloWorld.class, features);
    }
